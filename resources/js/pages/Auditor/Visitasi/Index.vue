...
<template>
    ...
    <div class="space-y-6 p-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">Visitasi</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kunjungan lapangan per lembaga akreditasi</p>
            </div>
        </div>
